...
exports.urlWithoutUserIdModel = exports.urlModel = void 0;
...
const UrlWithoutUserIdSchema = new mongoose_1.default.Schema({
    urlCode: { type: String, unique: true },
    longUrl: String,
    createdAt: { type: Date, default: Date.now(), expires: '180d' },
});
exports.urlModel = mongoose_1.default.model("Urls", UrlSchema);
exports.urlWithoutUserIdModel = mongoose_1.default.model("UrlsWithoutUserIds", UrlWithoutUserIdSchema);
